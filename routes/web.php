...
Route::middleware('customer-control')->group(function () {
    Route::prefix('customer')->group(function () {
        ...
        Route::get('/buy-totally-for-one', 'CustomerController@buyTotallyForOne')->name('buy-totally-for-one');
        Route::post('/buy-totally-for-one-post', 'CustomerController@buyTotallyForOnePost')->name('buy-totally-for-one-post');
    });
