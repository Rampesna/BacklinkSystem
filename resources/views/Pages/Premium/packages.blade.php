                ...
                <div class="col-lg-3 cool-md-4 col-sm-12">
                    <div class="card">
                        <ul class="pricing body">
                            ...
                            <li class="plan-btn"><a href="{{ route('edit-premium-package', \Illuminate\Support\Facades\Crypt::encrypt($package->id)) }}" class="btn btn-round btn-outline-secondary">Düzenle</a></li>
                        </ul>
                    </div>
                </div>
            @endforeach
